...
var _BooksTable = __webpack_require__(80);

var _BooksTable2 = _interopRequireDefault(_BooksTable);

var _AddBook = __webpack_require__(82);
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function loadBooks() {
            ...
            request.open('GET', _api2.default + '/book', true);
            ...
            request.onload = function () {
                ...
                _this2.setState({ bookList: books });
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', render: function render() {
                                        return _react2.default.createElement(_BooksTable2.default, { books: _this3.state.bookList });
                                    } }),
                                _react2.default.createElement(_reactRouterDom.Route, { path: '/add-book', component: _AddBook2.default })
                            )
                        )
                    )
                )
...
var API = window.Laravel.apiRoot;
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement('input', { className: 'form-control mr-sm-2', type: 'search', placeholder: 'Search books', 'aria-label': 'Search' }),
                _react2.default.createElement(
                    'button',
...
var _BookPreview = __webpack_require__(81);
...
function BooksTable(props) {
    ...
    if (!props.books) return _react2.default.createElement(
        "h4",
        null,
        "No books available"
    );

    var books = props.books.data;

    var booksList = books.map(function (book) {
        return _react2.default.createElement(
            "div",
            { className: "card", key: book.id },
            _react2.default.createElement(
                "div",
                { className: "card-header", id: book.title },
                _react2.default.createElement(
                    "h5",
                    { className: "mb-0" },
                    _react2.default.createElement(
                        "button",
                        { className: "btn btn-link", "data-toggle": "collapse", "data-target": "#" + book.id, "aria-expanded": "true", "aria-controls": "collapseOne" },
                        book.title
                    )
                )
            ),
            _react2.default.createElement(
                "div",
                { id: book.id, className: "collapse", "aria-labelledby": book.title, "data-parent": "#accordion" },
                _react2.default.createElement(
                    "div",
                    { className: "card-body" },
                    _react2.default.createElement(_BookPreview2.default, { book: book })
                )
            )
        );
    });
...
function BookPreview(props) {
    ...
    return _react2.default.createElement(
        "div",
        { className: "book-preview media" },
        _react2.default.createElement("img", { src: book.avatar, alt: book.title, className: "book-preview__img mr-3" }),
        _react2.default.createElement(
            "section",
            { className: "book-preview__info media-bdy" },
            _react2.default.createElement(
                "h5",
                { className: "book-preview__name mt-0" },
                book.title
            ),
            _react2.default.createElement(
                "p",
            ...
            _react2.default.createElement(
                "time",
                { className: "book-preview__publish" },
                book.published_at
            )
        )
    );
...
function AddBook(props) {
    ...
    function createNewBook(e) {
        ...
        request.open('GET', _api2.default + '/book/create', true);
    ...
    return _react2.default.createElement(
        'form',
        { action: _api2.default + '/book/create' },
        _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement('input', { type: 'text', className: 'form-control', id: 'inputEmail4', placeholder: 'Book title' })
        ),
        _react2.default.createElement(
            'div',
            { className: 'form-group' },
            ...
            _react2.default.createElement('input', { type: 'text', className: 'form-control', id: 'inputAddress', placeholder: 'Book author' })
        ),
        _react2.default.createElement(
            'div',
            { className: 'form-group' },
            ...
            _react2.default.createElement('input', { type: 'text', className: 'form-control', id: 'inputAddress2', placeholder: 'What is it about' })
        ),
        _react2.default.createElement(
            'div',
            { className: 'form-group' },
            ...
            _react2.default.createElement('input', { type: 'file', className: 'form-control-file', id: 'uploadBook' })
        ),
        _react2.default.createElement(
            'div',
            { className: 'form-row' },
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'button',
                    { type: 'submit', className: 'btn btn-primary', onClick: createNewBook },
                    'Add a book'
                )
            ),
            _react2.default.createElement(
